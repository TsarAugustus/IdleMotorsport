...
import { JoinSeries } from '../../Series/JoinSeries.js';
...
export let Goals = [{
	...
	Exclusive: [],
	Type: 'Series',
	ExecutionName: 'JoinSeries',
	Execution: function() { JoinSeries(); },
	Likelihood: 0,
	Completeed: false,
	Accepted: false
}, {
	...
	Exclusive: [],
	Type: 'Vehicle',
	ExecutionName: 'Vehicle',
	Execution: function() { Vehicle(); },
	Likelihood: 0,
	Completeed: false,
	Accepted: false
}];
